...
food.prototype.salads = function () {
  ...
  newDiv.append(newimg, title, ingredients, preparation, prep_info);
...
const pasta1 = new food(
  ...
  "Preparation :So so easy ☺️. Put everything together in a small blender or food processor and blend until everything is combined.Mix with your favorite pasta 🍝.",
  " 1 hrs , 10 min , 2 - 3 "
);
pasta1.pasta();
